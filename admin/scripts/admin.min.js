...
var user=function(){var a="/admin/user/",b=$("#btn-submit"),c=$("#user-dialog"),d=$("#user-dialog-title"),e=$(".modal-body"),f=$("#user-form"),g=$("#user-status");return{init:function(){g.val(g.attr("data-value")),b.click(function(){user.save()}),g.change(function(){liuxy.redirect(a.substr(1,a.length-1)+"?status="+g.val())}),$("#user-add").click(function(){d.html(lang.label.user.add),f[0].reset(),$("#id").val(""),$("#username").removeAttr("readonly"),c.modal()})},save:function(){$("#password").val($.md5($("#password").val())),liuxy.ajax(e,a+"save.json","json",f.serialize(),function(a){$("#password").val(""),message.success(e,{content:lang.success.edit})},function(a,b){$("#password").val(""),message.error(e,{content:b})},!0)},get:function(b){liuxy.ajax(e,a+"get.json","json",{id:b},function(a){$("#id").val(b),$("#name").val(a.name),$("#password").val(""),$("#username").val(a.username),$("#username").attr("readonly","realonly"),$("#trd_identifier").val(a.trd_identifier),$("input[name='status']").each(function(){return $(this).val()==a.status?($(this).parent().click(),!1):void 0}),a.roles&&$("input[type='checkbox']").each(function(){var b=$(this);$.each(a.roles,function(a,c){c.role_id==b.val()&&b.parent().click()})}),d.html(lang.label.user.edit),c.modal()},function(a,b){message.error(e,{content:b})},!0)}}}();